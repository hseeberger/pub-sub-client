...
## [0.13.5](https://github.com/hseeberger/pub-sub-client/compare/v0.13.4...v0.13.5) - 2026-09-19
...
- *(deps)* bump reqwest in the cargo-patch group across 1 directory
- *(deps)* bump composed from 0.1.1 to 0.1.2 in the cargo-patch group
- unify docker-compose and read its facts via composed

## [0.13.4](https://github.com/hseeberger/pub-sub-client/compare/v0.13.3...v0.13.4) - 2026-08-20

### Other

- *(deps)* update h2 to 0.4.17
- *(deps)* bump the cargo-patch group with 2 updates
- *(deps)* bump time from 0.3.54 to 0.3.55 in the cargo-patch group
- *(deps)* bump base64 in the cargo-major group across 1 directory
- *(deps)* bump the cargo-patch group with 6 updates
- *(deps)* bump tokio in the cargo-minor group across 1 directory
...
- *(deps)* bump time from 0.3.52 to 0.3.53 in the cargo-patches group
- *(deps)* bump time from 0.3.51 to 0.3.52 in the cargo-patches group
...
- add topic and subscription management
